#! Hacer un programa de numerología que ingrese los datos de la persona
#! y hacer su numerología completa, después guardar su nombre y sus 
#! fechas para procesarlos después. o guardar todas las variables de la persona
#! en un cvs para poder acceder a ellos después mediante un menu
...
class Person:
    ...
    def print_person(self) -> None:
        print(f"Name: {self.name}\nAlma: {self.alma}\nEgo: {self.ego}\nDon: {self.don}\nVidas Pasadas: {self.vidaspasadas}\nProposito: {self.proposito}\nDestino: {self.destino}")

list_of_people = []

def person_inputs() -> int:
    day = input("Dia con un guion(-) separando cada digito: ")
    month = input("Mes con un guion(-) separando cada digito: ")
    year = input("Año con un guion(-) separando cada digito: ")
    name = input("Pon el nombre completo dividido con espacios: ")
